// FIXED AUTO SETUP - Copy and paste this into browser console
// Make sure you're on localhost:3001 and logged in

console.log('🚀 Starting Fixed Auto Collection Creation...');
...
async function createCollectionsAndIndexes() {
  try {
    ...
    const { db, collection, doc, setDoc, getDocs, query, where, orderBy } = window;
    ...
    // Create collections with sample data (using new Date() instead of serverTimestamp)
