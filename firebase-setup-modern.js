// Firebase Setup Script for SecondChance Matrimony (Modern Firebase v9+ API)
...
let db;
let collection, addDoc, deleteDoc, getDocs, limit, query;

// Method 1: Try to access from window object if exposed
if (window.__SECONDCHANCE_FIREBASE__) {
  ...
  import('https://www.gstatic.com/firebasejs/10.7.1/firebase-firestore.js').then((firestore) => {
    ...
    console.log('✅ Firebase Firestore functions loaded');
    setupFirebase();
  }).catch(error => {
  ...
  console.log('📋 Please ensure your React app is loaded and Firebase is exposed');
