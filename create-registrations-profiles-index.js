// Create index for registrations collection (profiles page)
(async () => {
  console.log('🔧 Creating Firebase Index for Registrations Profiles...');
  ...
  try {
    ...
    console.log('https://console.firebase.google.com/v1/r/project/matrimony-events/firestore/indexes?create_composite=ClZwcm9qZWN0cy9tYXRyaW1vbnktZXZlbnRzL2RhdGFiYXNlcy8oZGVmYXVsdCkvY29sbGVjdGlvbkdyb3Vwcy9yZWdpc3RyYXRpb25zL2luZGV4ZXMvXxABGgoKBnN0YXR1cxABGg8KC3N1Ym1pdHRlZEF0EAIaDAoIX19uYW1lX18QAg');
    ...
    if (error.code === 'failed-precondition') {
      ...
      console.log('6. Fields: status (Ascending), submittedAt (Descending), __name__ (Descending)');
